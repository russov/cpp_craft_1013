...
{
	boost::asio::ip::address a = boost::asio::ip::address::from_string("233.200.79.5");

	stock_receiver sr;


	boost::asio::io_service service;
	boost::asio::ip::udp::endpoint endpoint( boost::asio::ip::address::from_string( "233.200.79.128" ), 50000 ); 
