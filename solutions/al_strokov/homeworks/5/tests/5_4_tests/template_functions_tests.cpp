...
{
	{
		...
		BOOST_CHECK_NO_THROW( clear_container( v1 ) );
	...
	}
	{
		...
		BOOST_CHECK_NO_THROW( clear_container( v2 ) );
...
{
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( m1 ) ) );
	...
	}
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( m2 ) ) );
	...
	}
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( m3 ) ) );
...
{
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( l1 ) ) );
	...
	}
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( l2 ) ) );
...
{
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( s1 ) ) );
	...
	}
	{
		...
		BOOST_CHECK_NO_THROW( ( clear_container( s2 ) ) );
